...
#### [Chapter 4: Design a Unique Code Generator](#chapter-4-design-a-unique-code-generator)
   - Problem and bottlenecks
   - RDBMS approach (why it fails)
   - Pre-generation + queue solution
   - Performance optimization

#### [Chapter 5: Design a Rate Limiter](#chapter-5-design-a-rate-limiter)
   - Problem statement
...
#### [Chapter 6: Design a URL Shortener](#chapter-6-design-a-url-shortener)
   - Problem statement
